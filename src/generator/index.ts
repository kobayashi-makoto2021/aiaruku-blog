...
<body>
  ...
  ${renderFooter()}
  <script>fetch('${BLOG_CONFIG.trackViewUrl}',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({slug:'${post.slug}',referrer:document.referrer}),keepalive:true}).catch(function(){})</script>
</body>
</html>`
}
